...
import Breadcamp2 from "../../Shared/Breadcamp2/Breadcamp2";

const ServiceContracts = () => {
  return (
    <>
      <Breadcamp2
        breadCampTitle={"Service Contracts"}
        // url={"/blog"}
            ...
            <div className="col-span-2 ">
              <div className="border border-BorderColor-0 rounded-md overflow-hidden " >
                ...
                <div className="px-2 sm:px-8 ">
                    ...
                    Forklift Service Contractors for Your Operational Needs 
                    </button>
                  ...
                  {/* <div className="flex flex-col bg-[#f3f4f8] sm:flex-row gap-7 px-4 sm:px-11 py-4 sm:py-10 rounded-md mt-12">
                    ...
                    Choose Our Forklift Service Contract for Maximum Efficiency and Protection
                    </button>
                    <button className="font-Inter font-semibold text-left text-xl sm:text-2xl text-[#313131] transition-all duration-500 hover:[#02416A] mt-2 mb-4 lg:text-xl">
                    Flexible Maintenance Scheduling
                    </button>
                  <p className="font-Poppins font-light ">
                  We respect the fact that you are precious. You don’t have to worry about your schedule when it comes to ordering our
                  <span className="text-[#FD9F00] font-medium"> repair and maintenance services</span>,we can tailor them to satisfy any business need or specification. Our goal is to minimize the time your equipment is offline and keep it in top working condition, whether you need a forklift repair or just some regular upkeep.
                  </p><br/>



                  <button className="font-Inter font-semibold text-left text-xl sm:text-2xl text-[#313131] transition-all duration-500 hover:[#02416A] mt-2 mb-4 lg:text-xl">
                  Guaranteed Response Time and Transparent Pricing
                    </button>
                  <p className="font-Poppins font-light ">
                  Transactions are transparent. The price is right on point with fixed response times for the services we offer forklift rental near me or urgent repair, you know when to expect a technician will pass what it cost and provided already charged credit cards to pay directly if not we’ll serve them a handsome bill anytime they want–with one trip included in return from our distributor service truck near your office doorstep free 
                  </p><br/>
                  <p className="font-Poppins font-light ">
                  Expert Technicians with Extensive Experience
                  </p><br/>
                  <p className="font-Poppins font-light ">
                  Our team consists of top-notch forklift operators and technicians with many years of experience. Whether it is sophisticated troubleshooting or routine maintenance we make sure that every service is first-rate.
                  </p><br/>
                  


                  <button className="font-Inter font-semibold text-left text-xl sm:text-2xl text-[#313131] transition-all duration-500 hover:[#02416A] mt-2 mb-4 lg:text-xl">
                  Comprehensive Warranty and Protection Coverage
                    </button>
                  <p className="font-Poppins font-light ">
                  All of the services like
                  <span className="text-[#FD9F00] font-medium">  training</span>we offer are covered by comprehensive warranty and protection plans. You can rest assured that your entire fleet is protected. Be free from care about unplanned repair bills with this peace of mind.
                  </p><br/>
                  <button className="font-Inter font-semibold text-left text-xl sm:text-2xl text-[#313131] transition-all duration-500 hover:[#02416A] mt-2 mb-4 lg:text-xl">
                  ...
                  Why Choose Us?
                    ...
                    <p className="font-Poppins font-light ">When it comes to forklift services, we stand out for our commitment to quality, transparency, and reliability. Here’s why businesses trust us:</p>

                    <div className="flex lg:flex-row items-start  mt-6 ">
  <div className="flex gap-2 items-center font-Poppins font-bold text-[#313131] lg:text-[15px] ">
  <FaSquare size={10} className="text-[#313131]" />Flexible schedules <span className="font-normal">that fit your operational needs</span> 
  </div>
                  ...
                  <ul className="flex flex-col gap-[14px] mt-3">
...
<p className=" font-Poppins font-normal text-[#313131] lg:text-[15px  ">
Whether you’re looking for a forklift driver, need to know the forklift price in KSA, or require a forklift rental service, we are your trusted partner for all your material handling needs.
  </p>
