  ...
  return (
    ...
    before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-[#02416A] before:opacity-80  before:-z-10 -mt-[16px]">
      ...
      <div className="relative z-10 grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-12 items-center gap-10 max-w-7xl mx-auto">
        ...
        <div className="sm:w-full lg:col-span-8 text-white px-4">
          <p className="font-Inter font-bold text-xl leading-8 sm:text-[38px] sm:leading-[48px] md:text-[44px] md:leading-[54px] lg:text-[30px] lg:leading-[40px] xl:text-[35px] xl:leading-[45px] 2xl:text-[44px] 2xl:leading-[54px]">
